...
const tests = [
  ...
  "test/test-artifact-change-plan-mutation-service.js",
  "test/test-artifact-change-plan.js",
  "test/test-artifact-content-index.js",
  "test/test-artifact-impact-index.js",
  "test/test-artifact-impact-locator.js",
  "test/test-artifact-incremental-validator.js",
  "test/test-artifact-incremental-repair.js",
  "test/test-artifact-production-request.js",
  "test/test-artifact-mutation-file-lease.js",
  "test/test-artifact-mutation-coordinator.js",
  "test/test-artifact-ownership.js",
  "test/test-artifact-revision-compaction-policy.js",
  ...
  "test/test-artifact-store-revisions.js",
  "test/test-artifact-type-policy.js",
  "test/test-artifact-validation.js",
  "test/test-cell-activation-scheduler.js",
  "test/test-cell-ai-binding.js",
  "test/test-cell-ai-binding-use-cases.js",
  "test/test-cell-config-store.js",
  "test/test-cell-cultivation-coordinator.js",
  "test/test-cell-cultivation-state-store.js",
  ...
  "test/test-cell-prompt-context-service.js",
  ...
  "test/test-cell-stimulus-admission.js",
  "test/test-cell-task-processing-service.js",
  "test/test-cell-task-store.js",
  "test/test-cell-thinking-service.js",
  ...
  "test/test-creation-svg-preview.js",
  "test/test-codex-provider-media.js",
  ...
  "test/test-document-extractor-registry.js",
  "test/test-document-stimulus-policy.js",
  ...
  "test/test-ingest-file-stimulus-use-case.js",
  ...
  "test/test-llm-call-scheduler.js",
  ...
  "test/test-stimulus-artifact-evolution-service.js",
  "test/test-stimulus-cultivation-service.js",
  "test/test-stimulus-relevance-policy.js",
